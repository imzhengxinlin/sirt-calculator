...
THRESHOLD_F = 0.5110  # Model F: Radiomics+DVH RF threshold
THRESHOLD_A = 0.3394  # Model A: DVH only XGB threshold
THRESHOLD_G = 0.5120  # Model G: Combined RF threshold (update after convert_g_onnx)
...
This tool implements two lesion-level predictive models for early tumor response 
...
| Features | Radiomics + DVH | DVH only |
| Val-AUC | 0.899 | 0.895 |
| Threshold | 0.52 | 0.34 |
| DeLong p-value | 0.953 (vs Model A) | 0.953 (vs Model F) |
